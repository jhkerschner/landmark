...
var Justice = function() {
    ...
    function f() {
        var a = 0;
        return window.chrome && window.chrome.loadTimes ? (a = 1e3 * window.chrome.loadTimes().firstPaintTime, 
        a -= 1e3 * window.chrome.loadTimes().startLoadTime, a.toFixed(0)) : "number" == typeof window.performance.timing.msFirstPaint ? (a = window.performance.timing.msFirstPaint, 
        a -= window.performance.timing.navigationStart, a.toFixed(0)) : "¯\\_(ツ)_/¯";
    }
    function g() {
    ...
    function i(a) {
        if (T) {
            var b = (a - T) / 1e3, c = 1 / b, d = Math.floor(c > 60 ? 60 : c);
    ...
    function o(a) {
        var b = 10;
        a.font = "600 " + b + "px sans-serif", a.fillStyle = D, a.fillText(0, 0, I), a.fillStyle = E, 
        a.fillText(30, 0, I / 2 + b / 2), a.fillStyle = F, a.fillText(60, 0, 0 + b);
    }
    function p(a) {
        var b = a.createLinearGradient(0, I, 0, 0);
        b.addColorStop(0, D), b.addColorStop(.25, D), b.addColorStop(.5, E), b.addColorStop(1, F), 
        a.strokeStyle = b, a.fillStyle = b;
    }
    function q(a) {
        for (var b = 0; 3 > b; b++) {
            var c = I / 2 * b + .5 - (2 === b ? 1 : 0);
            a.beginPath(), a.moveTo(.5 + K, c), a.lineTo(H + .5, c), a.lineWidth = 1, a.strokeStyle = C, 
            a.stroke();
        }
    }
    function r(a) {
    ...
    function v() {
        var a = z();
        P = document.createElement("div"), P.id = G, P.classList.add(G), P.classList.add(a), 
        document.body.appendChild(P), P = document.getElementById(G), P.innerHTML = [ '<div id="' + G + '-toggle" class="' + G + '-toggle"></div>', l(), m() ].join(""), 
        X.showFPS && u(), x();
    }
    function w() {
    ...
    function x() {
        document.getElementById(G + "-toggle").onclick = function() {
            ...
            a.className.match(" closed") ? (a.className = a.className.replace(" closed", ""), 
            y("open")) : (a.className += " closed", y("closed"));
        };
    }
    function y(a) {
    ...
    function A(a) {
        N++, X.showFPS && (i(a), Q(V, U, S)), null === M ? M = a : a - M > 3e3 && (M = a, 
    ...
    var C = "rgb(48, 48, 48)", D = "rgb(206, 69, 45)", E = "rgb(212, 202, 61)", F = "rgb(65, 155, 163)", G = "justice", H = 300, I = 40, J = I / 60, K = 20, L = H - K, M = 0, N = 0, O = null, P = null, Q = null, R = 0, S = [], T = null, U = null, V = null, W = {
        metrics: {
            TTFB: {
                budget: 200
            },
